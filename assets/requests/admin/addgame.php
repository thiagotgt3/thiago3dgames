                ...
                if ($addgame['import'] == 0) {
                    if (!empty($_POST['game_image'])) {
                        if (!empty($_POST['game_file'])) {
                            ...
                            $GameMonetizeConnect->query("INSERT INTO ".GAMES." (name, game_name, image, import, category, description, instructions, file, game_type, w, h, date_added, published, featured, rating, featured_sorting) VALUES ('{$addgame['name']}', '{$addgame['game_name']}', '{$addgame_mediaurl}', '0', '{$addgame['category']}', '{$addgame['description']}', '{$addgame['instructions']}', '{$addgame['file']}', '{$addgame['game_type']}', '{$addgame['width']}', '{$addgame['height']}', '{$time}', '{$addgame['published']}', '{$addgame['featured']}', '{$addgame['rating']}', '{$addgame['sorting']}')");
                    ...
                    if (isset($_FILES['__game_image']['tmp_name'])) {
                        if ($_FILES['__game_image']['size'] > 1024) {
                            ...
                            if (true) {
                                if(true) {
                                   $GameMonetizeConnect->query("INSERT INTO ".GAMES." (name, game_name , image, import, category, description, instructions, file, game_type, w, h, date_added, published, featured, rating, featured_sorting) VALUES ('{$addgame['name']}', '{$addgame['game_name']}' , '{$addgame_mediaurl}', '1', '{$addgame['category']}', '{$addgame['description']}', '{$addgame['instructions']}', '{$addgame['file']}', '{$addgame['game_type']}', '{$addgame['width']}', '{$addgame['height']}', '{$time}', '{$addgame['published']}', '{$addgame['featured']}', '{$addgame['rating']}', '{$addgame['sorting']}')");
